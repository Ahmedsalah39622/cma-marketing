...
export default function ContactPage() {
  ...
  // Scroll to form section when page loads or when "scroll=form" query param is present
  useEffect(() => {
    const scrollToForm = searchParams.get('scroll') === 'form';

    if (scrollToForm && formSectionRef.current) {
      // Jump to top first so the smooth animation starts from the top of the page
      // then smooth-scroll to the target element. Small timings ensure layout is ready.
      window.scrollTo({ top: 0, left: 0, behavior: 'auto' });

      setTimeout(() => {
        const el = formSectionRef.current!;
        const headerOffset = 96; // adjust if your header is taller
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: 'Phone',
      details: [ '+20 1113146750'],
      description: 'Sun-Thurs from 8am to 6pm.'
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['novix.its.co@gmail.com'],
      description: 'Online support 24/7'
    },
    {
      icon: MapPin,
      title: 'Office',
      details: ['Helmiet El-Zaitoun, Cairo, Egypt'],
          ...
          >
            ...
            {status === 'success' && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="mb-6 p-4 bg-green-500/10 border border-green-500/30 rounded-xl text-green-300"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/50"
                  placeholder="Name"
                  required
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-white/10 border border-white/10 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-primary/50 appearance-none cursor-pointer"
                >
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={6}
                className="w-full px-4 py-3 bg-white/10 border border-white/10 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none"
            ...
            >
              <Button
                type="submit"
                disabled={loading}
                className="w-full bg-primary hover:bg-primary/90 text-white py-4 rounded-xl font-medium flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="lg:col-span-1">
              <motion.div
                ...
                className="bg-green-500/10 backdrop-blur-xl rounded-2xl p-8 border border-green-500/30 h-full flex flex-col justify-center items-center text-center"
              >
                ...
                <a
                  ...
                  className="w-full px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-xl transition-colors flex items-center justify-center gap-2"
                >
